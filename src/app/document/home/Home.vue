<template>
  <div>
    ...
    <div style="width:100%;height:500px">
      <span style="width:50%;height:500px; ">
        <vue-donut-chart title="在线教育比例" :data="donutData" unit="人" />
      </span>
    </div>
    </div>
  </div>
...
export default {
  data(): any {
      return {
          donutData: [{ label: '吉他', value: 20 }, { label: '架子鼓', value: 90}, { label: '钢琴', value: 50 }, { label: '电子琴', value: 40 }]
      };
  },
  metaInfo: {
    ...
    meta: [
      ...
      {
        name: 'keywords',
        content: '一键找乐手,一键组乐队,一键接商演,一键找琴行,一键找服务,一键找资源,区块链商城,所见即所得',
      },
      { name: 'og:url', content: 'http://www.puddor.com/' },
      { name: 'og:site_name', content: 'puddor' },
