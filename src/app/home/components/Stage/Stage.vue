<template>
  <div :class="$style.stage" ref="stage">
    ...
    <vue-grid>
      <vue-grid-row>
        <vue-grid-item class="vueGridItem" fill="#32101B">
          <img src="logo.png" alt="蒲灯儿" />
          <vue-headline level="1">蒲灯儿</vue-headline>
          ...
          <a href="/" target="_blank" rel="noopener" aria-label="vuesion github repository">
            <vue-icon-github />
          </a>
        </vue-grid-item>
      </vue-grid-row>
